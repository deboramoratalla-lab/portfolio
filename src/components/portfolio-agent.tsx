...
const prompts = [
  ...
  "How does Debora use coded prototypes before Figma?",
]
...
const answers = {
  ...
  prototypes: { title: "She prototypes behaviour in code when that is the fastest way to test it.", body: "Debora does not treat Figma as a mandatory step between an idea and a useful test. In Board, she used a coded workflow to make roles, task states, dependencies and approvals inspectable across the full journey. In Civeo, she built a working municipal-operations POC directly in HTML, CSS and JavaScript so internal workers could test navigation, editable widgets, live states and the contextual assistant as behaviour — not as a presentation.", evidence: [{ label: "Board · coded workflow prototype", href: "/projects/saas#board-02" }, { label: "Civeo · coded municipal operations POC", href: "/projects/civeo" }] },
  civeo: { title: "Civeo proved the operating model before a platform existed.", body: "Civeo began with an Excel-led process where internal teams had to reconstruct operational context across files and service views. Debora reframed it as one working surface: a four-level hierarchy, editable widgets, explicit live and offline states, and a contextual assistant. She implemented the POC in code and used it with 15 internal workers, making the proposed behaviour tangible without needing a full production backend or a static handoff first.", evidence: [{ label: "Civeo · coded municipal operations POC", href: "/projects/civeo" }] },
