...
type Health = { updatedAt: string; workflow: { name: string; conclusion: string | null; updatedAt: string; href: string } | null; openIssues: number; components: number; componentNames: string[]; component: string; componentFiles: number; unavailable?: boolean }
