...
const articles: Record<string, ArticleContent> = {
  "decision-handover": {
    ...
    sections: [
      { title: "Situation: the framework had to survive its maker", paragraphs: ["At TAP, I was creating the framework while leading the product team’s work and tasks. That made continuity a real design problem: a decision could be visible in a board or a conversation, while the reason for it remained implicit in the person who had been carrying the work.", "The risk was not that people lacked information. It was that the next person could see what had changed without knowing why a choice had been made, or what would make it worth reopening."] },
      { title: "Task: carry the reasoning, not every trace", paragraphs: ["I wanted to test a smaller handover pattern than a full activity log. The next person needed enough context to judge an active decision, without being asked to reconstruct a day of work or read another inbox.", "The constraint was deliberate: routine work should stay quiet. Only a decision with an owner, a rationale and a clear review condition should travel forward."] },
      { title: "Action: turn a decision into a readable object", paragraphs: ["I built a coded dashboard around three fields: what was decided, why it was reasonable at that moment and what condition would make it worth reviewing. The schedule makes active decisions scannable first. Selecting one exposes the context without leaving the workspace.", "The review state matters most. When a condition is crossed, the interface does not pretend to know the next action. It brings the original reasoning back to the person responsible for reassessing it. The controls record a local prototype state only."] },
      { title: "Result: a testable handover hypothesis", paragraphs: ["The result is an interaction hypothesis, not a TAP feature or a claim of production impact. It gives a product team a compact way to test whether decisions can remain legible when the work moves between people.", "The boundary is part of the solution: create a receipt only when a choice carries risk, cost or a service-level consequence, and when someone can name what would make it worth revisiting."] },
    ],
