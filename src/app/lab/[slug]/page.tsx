...
const articles: Record<string, ArticleContent> = {
  "gpu-job-triage": {
    lead: "I built a decision model for a familiar AI infrastructure moment: utilisation falls, the next cost threshold gets closer and someone needs to decide whether to keep capacity, investigate or pause a batch.",
