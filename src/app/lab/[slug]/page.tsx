...
const articles: Record<string, ArticleContent> = {
  ...
  "european-tech-opportunity-radar": {
    ...
    sections: [
      ...
      { title: "Keep the source visible", paragraphs: ["Each listing keeps a direct route back to its original source. The tool does not claim to be complete, and it does not infer salary, seniority or eligibility when the feed does not provide it.", "The current version reads public remote-job feeds from Jobicy, Remotive and Remote OK, Linear’s public Ashby job board directly, and global remote searches from the Glassdoor job-search API supplied by OpenWeb Ninja. Listings are categorised from the title and supplied category; location and any hiring restriction remain visible rather than being guessed."] },
