...
const articles: Record<string, ArticleContent> = {
  ...
  "european-tech-opportunity-radar": {
    ...
    sections: [
      ...
      { title: "Keep the source visible", paragraphs: ["Each listing keeps a direct route back to its original source. The tool does not claim to be complete, and it does not infer salary, seniority or eligibility when the feed does not provide it.", "The current version reads public remote-job feeds from Jobicy, Remotive and Remote OK, Linear’s public Ashby job board directly, and remote-Europe searches from the Glassdoor job-search API supplied by OpenWeb Ninja. Listings remain limited to roles marked Europe or Anywhere, then categorised from the title and supplied category."] },
