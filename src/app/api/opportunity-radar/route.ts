...
function categoryFor(title: string, sourceCategory = "") {
  ...
  if (/\bproduct\b|\bproject\b|\bprogram\b/.test(text)) return "Product & Operations"
  ...
  if (/content designer|brand designer|visual designer|creative director|graphic designer|motion designer|art director|illustrator|copywriter|video editor|\bdesigner\b/.test(text)) return "Creative & Brand"
