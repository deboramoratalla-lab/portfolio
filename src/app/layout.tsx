...
export const metadata: Metadata = {
  ...
  title: { default: "Debora Moratalla — Product Designer & Builder", template: "%s — Debora Moratalla" },
  ...
  openGraph: { title: "Debora Moratalla — Product Designer & Builder", description: "Product design for technical systems, enterprise tools and AI workflows.", url: "https://deboramoratalla.com", siteName: "Debora Moratalla", locale: "en_GB", type: "website", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Debora Moratalla — Product Designer & Builder" }] },
  twitter: { card: "summary_large_image", title: "Debora Moratalla — Product Designer & Builder", description: "Product design for technical systems, enterprise tools and AI workflows.", images: ["/opengraph-image"] },
