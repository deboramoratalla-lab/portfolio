...
export function HomePreview() {
  return <main id="top" className="aeye-home-preview">
    ...
    <section className="personal-note section" id="about"><MotionSectionTitle title="A note" number="05"/><div><p>I started with spaces, images and stories. Product gave me a new material: behaviour.</p><span>That path still shapes how I work: looking for structure, noticing what is missing and making difficult ideas easier to navigate.</span><small className="personal-note__ai">I’m especially interested in AI systems that know when to act, when to wait and when to hand control back.</small></div></section>
  </main>
}
