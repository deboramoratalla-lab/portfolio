...
export const portfolioEvidence: PortfolioEvidence[] = [
  ...
  { id: "cv-profile", label: "Experience · professional profile", href: "/experience", claims: ["Debora is a Product Designer with 8+ years in digital products and 12+ years across design, systems and creative direction.", "Her background spans product design, design systems, visual design, service design, interiors, art direction and code."] },
