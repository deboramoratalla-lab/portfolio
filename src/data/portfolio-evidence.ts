...
export const portfolioEvidence: PortfolioEvidence[] = [
  ...
  { id: "cv-profile", label: "Experience · professional profile", href: "/experience", claims: ["Debora is a Product Designer with 8+ years across B2B SaaS, enterprise software, health, technology and entertainment.", "Her background spans product design, design systems, visual design, service design, interiors, art direction and code."] },
  ...
  { id: "cv-freelance", label: "Experience · product leadership", href: "/experience#freelance", claims: ["As a freelance Lead Product Designer from 2021 to 2024, Debora led TAP Mindset, built its design system, conceived AccessIA and designed a smart-city dashboard for Telefónica."] },
