...
export const projects: Project[] = [
  {
    ...
    chapters: [
      { number: "01", title: "The diagnosis", thesis: "The brief described a UI problem. The work exposed a coordination problem.", sections: [
        { title: "A menu, not a coordination tool.", body: ["Every calculation, approval and workflow existed. Yet the finance teams responsible for keeping the cycle moving still coordinated it through email.", "One task stalled upstream held twenty-four regional leads downstream. The only mechanism for detecting that stall was somebody asking."], media: "/media/fL9YsjcUWjmuDS7xICXN72fDkpY.png" },
        { eyebrow: "First attempt", title: "My first answer was the one they asked for.", body: ["The brief said make it more visual, show the workflow. So I mapped the whole budget process into a single visual flow.", "It showed where the stops were, but not where each user was. A user could trace the process end to end and still not answer: where am I right now, and what is waiting on me?"], media: "/media/euI7feC9sysqqis8gqXR6X4QOo.png" },
        { title: "Four questions the system never answered.", body: ["Users held the operating model in memory. Mapping made the gap concrete."], points: [["Progress","Where am I, and what is complete?"],["Ownership","Who approves this? Who owns next?"],["Dependencies","What is blocking me?"],["Next steps","What should I do now?"]] }
      ]},
      { number: "02", title: "The system", thesis: "Rules first. Screens second.", sections: [
        { title: "The coordination layer that was missing.", body: ["A persistent status bar survives every screen. Priorities are ordered by downstream consequence, dependencies become a first-class column, and workflow state is never optional."], video: "/media/hi5RUlder0uFb2zoYYPHJlwIt3E.mov" },
        { title: "The senior decision is often the thing you choose not to ship.", body: ["I rejected status distributed across existing screens, a breadcrumb that ignored dependencies, and a configurable dashboard that would make workflow state optional.", "I traded flexibility for a guarantee."], points: [["Rejected","Status inside existing screens"],["Rejected","A breadcrumb instead of dependencies"],["Rejected","A configurable dashboard"]] },
        { eyebrow: "Leadership & alignment", title: "I turned three local perspectives into one operating model.", body: ["I facilitated working sessions with National Finance, regional controllers, agency users, Product and Engineering. A shared decision log separated policy from preference and made ownership explicit."] }
      ]},
      { number: "03", title: "From product to system", thesis: "The most durable output wasn’t a screen.", sections: [
        { title: "A rule library the next project could reuse.", body: ["The rule library connected workflow principles, screen behaviour and acceptance criteria — giving future projects proven patterns instead of a blank page."], metrics: [["24","Design rules"],["3","Roles modelled"],["06","Reusable patterns"]], media: "/media/9j6WjZoUkauvEI9LNsWRRL3GYGw.png" },
  ...
  },
  {
    ...
    chapters: [
      { number: "01", title: "The problem worth solving", thesis: "The visible issue was inconsistency. The consequential one was maintenance.", sections: [
        { title: "The system was not failing because components were missing.", body: ["TAP Mindset started as an MVP. Every sprint added flows, features and decisions. But documenting one component took 45–60 minutes, and that time always lost against the roadmap.", "Knowledge lived in people, not in the system."], media: "/media/8E3h5foMKSIxJzUkdIrbzLfEFgM.png" },
        { eyebrow: "The audit", title: "Not designing. Counting.", body: ["I mapped every flow and audited 28,000+ component instances. That exposed which patterns were load-bearing, which were duplicates and which existed for no reason at all."], metrics: [["28,000+","Instances audited"],["30+ h","Repeat documentation"],["4","Drifting brand scales"]] }
      ]},
      { number: "02", title: "The system & the bet", thesis: "Establish a source of truth, reduce what the team had to maintain, then close the loop between code and design.", sections: [
        { eyebrow: "The source of truth", title: "Foundations by hand. Components from evidence.", body: ["I designed color, type, spacing, elevation, radius, grid and motion without AI. Usage data then shaped the component layer.", "I reduced the public API from 55 concepts to 38 — merging duplicates, promoting real patterns and archiving what nobody used."], media: "/media/v0e9L7cLZpgOZ1Yikq3r8RoqLY.png" },
        { title: "A source of truth the team could inspect, use and challenge.", body: ["Storybook made the system tangible: foundations, brand rules and production components lived together, with implementation and documentation in the same place."], media: "/media/UHTiiwNdPuTkZcoyyv0CB6hTHrY.png" },
        { eyebrow: "Code component importer", title: "Reads code and rebuilds its structure in Figma.", body: ["Once code became the source of truth, manual syncing had an expiry date."], video: "/media/VDnyOmgwVTRRwyqN4yVYpCa2Q.mov" },
        { eyebrow: "Document generator", title: "Clones a master template and generates the full doc page.", body: ["The plugins carried structure, not judgment. Code could expose variants, slots and tokens; it could not decide whether a pattern should be one component or five."], video: "/media/DKUq3U6NX0ztkYDZUy6Xg3Y7ww.mov" }
      ]},
      { number: "03", title: "What it cost, what it taught", thesis: "The measurable gains mattered. So did the failures.", sections: [
        { title: "AI accelerated execution — and mistakes — with equal efficiency.", body: ["The parity audit exposed four brand scales that had silently drifted apart. Weak context produced fast but inconsistent output. A version restore forced part of the consolidation to be rebuilt."], metrics: [["55 → 38","Component concepts"],["45 → <2 min","Documentation time"],["4","Brand scales reconciled"]] },
  ...
  },
  {
    ...
    chapters: [
      { number: "01", title: "Reframing the product", thesis: "The experience was organised around features, not user intent.", sections: [
        { title: "A fragmented architecture was becoming a growth constraint.", body: ["Every new feature increased the decisions users faced, multiplied role-specific exceptions and created more design and engineering divergence.", "The risk was not visual inconsistency; it was a product that became harder to adopt and more expensive to evolve."], media: "/media/8vYUA69ov7JIByTeoOntKRg1Bb4.png" },
        { eyebrow: "The diagnosis", title: "Four symptoms. One structural cause.", body: ["The redesign had to reduce decisions without reducing agency."], points: [["01","Cognitive overload"],["02","Blurred mental models"],["03","Inconsistent interactions"],["04","A system that could not scale"]] }
      ]},
      { number: "02", title: "Designing the system", thesis: "Four principles turned a broad redesign into a decision system.", sections: [
        ...
        { eyebrow: "The first bet", title: "Activation before personalisation.", body: ["We shortened onboarding and delayed personalisation until after the first meaningful session. The trade-off was deliberate: less tailoring upfront, more momentum when motivation was highest."], points: [["Before","Personalise first"],["Decision","Reach value sooner"],["After","Personalise progressively"]] },
      ...
      { number: "03", title: "Building the experience", thesis: "One clear path, with depth available when needed.", sections: [
        { title: "Prepare, train, reflect and return.", body: ["Daily actions and long-term progress became distinct but connected. Navigation communicated what came next, while progressive disclosure kept exploratory routes available without competing with the primary task."], media: "/media/m8mVArIM9VzKohEm4ONZgSbfY.png" },
        { title: "Simplification became a problem when it removed context.", body: ["Early iterations were too restrictive for exploratory users. I reintroduced progressive disclosure: the primary action stayed obvious, but deeper layers remained available when the moment required them."], media: "/media/F2QELFSYF2MG5Cgw8Xr4XZKexlo.png" }
      ]},
      { number: "04", title: "What changed", thesis: "The product made its own logic visible.", sections: [
  ...
  },
  {
    ...
    chapters: [
      { number: "01", title: "The mismatch", thesis: "A top-up problem was only the visible edge of a much larger burden.", sections: [
        { title: "The opportunity was to remove the need to manage commuting at all.", body: ["Commuters still have to remember their balance, compare routes, monitor disruption and recover when the network changes.", "The product question was not how to make one task faster, but which decisions software could responsibly take off the passenger’s plate."], media: "/media/2b7YNCK8WXiTCdQRa84XPV7867M.png" },
        { eyebrow: "The business bet", title: "Fewer failure moments, not more app engagement.", body: ["For an operator, the value is operational: prevent low-balance failures, reduce avoidable support contacts and protect journey completion when the network changes."] }
      ]},
      { number: "02", title: "From route planner to agent", thesis: "The strategic move was a product that decides when interaction is necessary.", sections: [
        ...
        { eyebrow: "Interactive model", title: "See how Fluxy reasons before it intervenes.", body: ["Start with a passenger goal, introduce a change in context and see how Fluxy prepares a recommendation while keeping the final decision explicit."], media: "/media/Mmfb40qOiaxKtQrgIFMJi6A.png" }
      ]},
      { number: "03", title: "Designing responsible autonomy", thesis: "Trust needed an interaction model, not a reassuring tone of voice.", sections: [
      ...
      { number: "04", title: "Proving the model", thesis: "Three moments tested whether autonomy could still feel understandable and controlled.", sections: [
        { eyebrow: "Daily brief", title: "Build trust before disruption", body: ["A single morning view communicates the plan, confidence and anything worth knowing — without turning commuting into another dashboard."], media: "/media/Mmfb40qOiaxKtQrgIFMJi6A.png" },
        { eyebrow: "Smart recharge", title: "Autonomy stops at payment", body: ["Fluxy monitors balance and recommends a recharge only when necessary. It prepares the action; the passenger authorises the transaction."], media: "/media/3ZRShN2uu7UG2p8p8J3RXWpJg1U.png" },
        { eyebrow: "Goal protection", title: "The objective survives change", body: ["When disruption threatens arrival, Fluxy explains what changed and recommends a new route in terms of the passenger’s priority."], media: "/media/1OrTKFTrcLckBt1fLOZU36fom5s.png", metrics: [["5/6","Understood why Fluxy intervened"],["6/6","Expected payment confirmation"],["12","Scenarios tested"]] }
      ]}
    ]
  }
]
